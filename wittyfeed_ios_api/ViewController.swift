...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //
        WittyFeedSDKSingleton.instance.wittyFeed_sdk_api_client = WittyFeedSDKApiClient(apikey: API_KEY, appid: APP_ID, fcmtoken: FCM_TOKEN, usermeta: user_meta, vc: self)
        
        WittyFeedSDKSingleton.instance.wittyFeed_sdk_main = WittyFeedSDKMain(vc: self, wittyFeedSDKApiClient:  WittyFeedSDKSingleton.instance.wittyFeed_sdk_api_client)
        ...
        //
        WittyFeedSDKSingleton.instance.wittyFeed_sdk_main.prepare_feed();
    ...
    @IBAction func didTapWaterfallButton(_ sender: Any) {
        // ===============================
